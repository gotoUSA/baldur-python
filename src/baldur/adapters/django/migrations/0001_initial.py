...
# Initial migration for baldur Django models
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="baldur_started_db4926_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="postmortemrecord",
            ...
            fields=[
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Unique Cascade Event ID",
                    ),
                ),
                (
                    "namespace",
                    models.CharField(
                        ...
                        help_text="Namespace where the event originated",
                    ),
                ),
                (
                    "trigger_type",
                ...
                (
                    ...
                    models.JSONField(
                        ...
                        help_text="List of cascaded effects",
                    ),
                ),
                (
                    "causation_chain",
                    models.JSONField(
                        ...
                        help_text="Causation chain of event IDs",
                    ),
                ),
                (
                    "previous_hash",
                    models.CharField(
                        ...
                        help_text="Hash of the previous Cascade Event",
                    ),
                ),
                (
                    "current_hash",
                    models.CharField(
                        ...
                        help_text="SHA-256 hash of this Cascade Event",
                    ),
                ),
                (
                    "total_effects",
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text="Cascade Event timestamp",
                    ),
                ),
                (
                    "archived_at",
                    models.DateTimeField(
                        ...
                        help_text="Timestamp when archived to PostgreSQL",
                    ),
                ),
                (
                    "external_trace",
                    models.JSONField(
                        ...
                        help_text="W3C Trace Context integration data",
                    ),
                ),
                (
                    "version",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        help_text="Whether this is a test environment event (X-Test-Mode)",
                    ),
                ),
            ],
            options={
