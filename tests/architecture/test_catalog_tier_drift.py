...
silently. G37 is the inverse of the ADR-008 claim-wiring gates: it keeps the
...
Rule registry: ``docs/laws/ARCHITECTURAL_FITNESS_FUNCTIONS.md#g37-catalog-tier-drift``
"""
...
class TestModulePathStatus:
    ...
    def test_existing_pro_path_ok(self):
        # baldur_pro is installed in the monorepo checkout.
        assert catalog_module_path_status("services/dlq/") == "ok"

    def test_missing_path_is_missing(self):
        # The stale path 589 fixes — absent everywhere, all roots present here.
        assert catalog_module_path_status("resilience/bulkhead/") == "missing"
