...
(PRO depends on OSS, never the reverse).

Rule registry:
``ARCHITECTURE.md#g17-pro-import-boundary``
``ARCHITECTURE.md#g17b-pro-import-count``
``ARCHITECTURE.md#g17c-dormant-import-count``
