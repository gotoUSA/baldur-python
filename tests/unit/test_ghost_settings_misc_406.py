...
class TestSettingsRemovalContract:
    ...
    def test_scaling_hpa_metrics_enabled_removed(self):
        """ScalingSettings no longer has 'hpa_metrics_enabled' field."""
        from baldur.settings.scaling import ScalingSettings

        assert "hpa_metrics_enabled" not in ScalingSettings.model_fields
